...
class CatalogAllExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    public function map($line):array {
      ...
      //dd($line);
        ...
        return [
            ...
            $line->supplier->supplier_cod,   //'Cód do fornecedor',
            $line->supplier->name,           //'Fornecedor',
            '',                              //'Localização',
            '',                              //'Estoque máximo',
            '',                              //'Estoque mínimo',
